(function() {
  ...
  window.Routes = {
// application_assignment => /:id(.:format)
  application_assignment_path: function(_id, options) {
  return Utils.build_path(["id"], ["format"], [2,[2,[7,"/",false],[3,"id",false]],[1,[2,[8,".",false],[3,"format",false]],false]], arguments);
  },
// application_assignments => /
  application_assignments_path: function(options) {
...
// drag_update_application_assignments => /drag_update(.:format)
  drag_update_application_assignments_path: function(options) {
  return Utils.build_path([], ["format"], [2,[2,[7,"/",false],[6,"drag_update",false]],[1,[2,[8,".",false],[3,"format",false]],false]], arguments);
  },
// edit_application_assignment => /:id/edit(.:format)
  edit_application_assignment_path: function(_id, options) {
  return Utils.build_path(["id"], ["format"], [2,[2,[2,[2,[7,"/",false],[3,"id",false]],[7,"/",false]],[6,"edit",false]],[1,[2,[8,".",false],[3,"format",false]],false]], arguments);
  },
...
// new_application_assignment => /new(.:format)
  new_application_assignment_path: function(options) {
  return Utils.build_path([], ["format"], [2,[2,[7,"/",false],[6,"new",false]],[1,[2,[8,".",false],[3,"format",false]],false]], arguments);
  },
